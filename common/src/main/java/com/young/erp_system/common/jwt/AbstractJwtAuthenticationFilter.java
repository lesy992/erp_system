...
public abstract class AbstractJwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final JwtProviderBase jwtProvider;
    private final TokenBlacklistPort tokenBlacklistService;

    protected AbstractJwtAuthenticationFilter(JwtProviderBase jwtProvider, TokenBlacklistPort tokenBlacklistService) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return PATH_MATCHER.match("/swagger-ui/**", uri)
    ...
    protected void unauthorized(HttpServletResponse response, ErrorCode errorCode) throws IOException {
